...
// From: https://wolles-elektronikkiste.de/en/tinywirem-vs-wire-for-attinys
#include <TinyWireM.h>
...
void setup() {
    ...
    oled.on();
    oled.setCursor(27, 4); // x: pixel / y: line
    oled.print("3WA Hello world");    
}
...
void loop() {
    ...
    if (millis() - lastVoltageCheck > 3000) {
        ...
        oled.setCursor(27, 2); // x: pixel / y: line        
        oled.print("      ");
        oled.setCursor(27, 2); // x: pixel / y: line        
